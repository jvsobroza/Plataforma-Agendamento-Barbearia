...
class ServicoController extends Controller
{
    ...
    public function store(StoreServicoRequest $request)
    {
        ...
        return redirect()->route('barbeiro.index')->with('success', 'Serviço criado com sucesso!');
    }
    ...
    public function update(UpdateServicoRequest $request, $id)
    {
        ...
        return redirect()->route('barbeiro.index')->with('success', 'Serviço editado com sucesso!');
    }
    ...
    {
        Servico::destroy($id);
        return redirect()->route('barbeiro.index')->with('success', 'Serviço apagado com sucesso!');
    }
}
